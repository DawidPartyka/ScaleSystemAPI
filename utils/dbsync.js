...
const { Tuning, User, UserLog, UserScale, TimeSignature, Scale, ScaleViews, Management, Jamtrack, Instrument, CustomScale,
    Artist, JamtrackScales, JamtrackArtists, JamtrackTimeSignatures, Genre, Featured } = require(pathModels + 'allModels');
